...
public class Node {
	...
	/*public void setData(int possibility, boolean data){
		this.data[possibility] = data;
	}
*/
	...
	public static void displayTrue(Node root){
		int count = 0;
		...
		while(ymarker != null){
			...
			while(marker != null){
				count++;
				System.out.print(marker.getValue()+1 + " ");
				if(count%3 == 0){
					System.out.print("  ");
				}
				if(count%27 == 0){
